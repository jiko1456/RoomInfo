...
public class RoomInfo_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelBtn1 = (TextView) findViewById(R.id.cancelBtn1);
        naviBtn1 = (TextView) findViewById(R.id.naviBtn1);
        ...
        naviBtn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
