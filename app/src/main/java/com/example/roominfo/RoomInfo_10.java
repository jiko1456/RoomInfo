...
public class RoomInfo_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linear = (LinearLayout) inflater.inflate(R.layout.lectureroom_10, null);
        ...
        adapter.addItem(new RoomInfoItem("1F", R.drawable.toilet, R.drawable.cafe, R.drawable.printer, R.drawable.machine, R.drawable.transparent));
        ...
        adapter.addItem(new RoomInfoItem("5F", R.drawable.toilet, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
        adapter.addItem(new RoomInfoItem("6F", R.drawable.toilet, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
        adapter.addItem(new RoomInfoItem("7F", R.drawable.toilet, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
