...
public class RoomInfo_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linear = (LinearLayout) inflater.inflate(R.layout.lectureroom_3, null);
        ...
        adapter.addItem(new RoomInfoItem("1F", R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
