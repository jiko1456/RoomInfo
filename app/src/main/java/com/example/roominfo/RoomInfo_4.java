...
public class RoomInfo_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linear = (LinearLayout) inflater.inflate(R.layout.lectureroom_4, null);
        ...
        adapter.addItem(new RoomInfoItem("1F", R.drawable.printer, R.drawable.machine, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
