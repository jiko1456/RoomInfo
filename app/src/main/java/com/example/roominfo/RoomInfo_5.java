...
public class RoomInfo_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linear = (LinearLayout) inflater.inflate(R.layout.lectureroom_5, null);
        ...
        adapter.addItem(new RoomInfoItem("1F", R.drawable.printer, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
