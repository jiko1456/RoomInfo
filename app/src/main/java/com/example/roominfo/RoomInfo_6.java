...
public class RoomInfo_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linear = (LinearLayout) inflater.inflate(R.layout.lectureroom_6, null);
        ...
        adapter.addItem(new RoomInfoItem("B1F", R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
        adapter.addItem(new RoomInfoItem("1F", R.drawable.man, R.drawable.printer, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
        adapter.addItem(new RoomInfoItem("2F", R.drawable.woman, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
        adapter.addItem(new RoomInfoItem("3F", R.drawable.man, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
        adapter.addItem(new RoomInfoItem("4F", R.drawable.woman, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent, R.drawable.transparent));
